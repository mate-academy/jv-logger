...
public class OrderServiceImpl implements OrderService {
    private static final String COMPLETE_ORDER_WAS_CALLED
            = "Method completeOrder was called. Params: userId {}";
    private static final String GET_ALL_PRODUCTS_SUCCESSFUL
            = "Method getAllProductsFromShoppingCart successful fetched data from DB."
            + " Params: userId {}";
    private static final Logger logger = LogManager.getLogger(AuthenticationServiceImpl.class);

    @Override
    public Order completeOrder(Long userId) {
        logger.info(COMPLETE_ORDER_WAS_CALLED, userId);
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info(GET_ALL_PRODUCTS_SUCCESSFUL, userId);
        return products;
    }
}
