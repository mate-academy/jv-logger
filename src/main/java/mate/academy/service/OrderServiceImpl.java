...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        logger.info("OrderServiceImpl completeOrder method is called. UserId: {}", userId);
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info("OrderServiceImpl getAllProductsFromShoppingCart method is done "
                + "for userId: {}, productList is: {}",
