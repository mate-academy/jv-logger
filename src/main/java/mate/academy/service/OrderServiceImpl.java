...
public class OrderServiceImpl implements OrderService {
    private static final Logger loger = LogManager.getLogger(OrderServiceImpl.class);

    @Override
    public Order completeOrder(Long userId) {
        loger.info("completeOrder() method was called. Params = {}",userId);
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        loger.info("getAllProductsFromShoppingCart() method successfully fetched data from DB."
                + "Params = {}", userId);
        return products;
    }
}
