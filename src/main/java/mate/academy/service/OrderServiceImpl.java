...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        ...
        logger.info("CompleteOrder method was called with param: userId = {}", userId);
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info("Data from DB successfully fetched by param: userId = {}"
                + "\nData from DB = {}", userId, products.stream()
