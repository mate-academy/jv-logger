...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        ...
        order.setOrderId(1L);
        logger.info("order identifier for orderId = {} userId = {}",
                order.getOrderId(), order.getUserId());
        return order;
    }

    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        logger.debug("getAllProductsFromShoppingCart method was called. Param: userId = {}",
                userId);
        ...
        logger.info("successful fetched data from DB for products: {}",products);
        return products;
    }
}
