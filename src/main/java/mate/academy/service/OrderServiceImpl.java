...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        ...
        logger.trace("Method 'completeOrder' was called");
        ...
        order.setOrderId(1L);
        logger.info("Order parametrs = {}, order = {}", userId, order);
        return order;
    }
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info("Successful fetched data from DB userId {} products = {}", userId, products);
        return products;
    }
}
