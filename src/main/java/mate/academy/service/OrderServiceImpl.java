...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        logger.debug("CompleteOrder method was called. Parameter: userId : {}", userId);
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info("The method worked correctly with the data extracted from the"
                + " database for this user. Parameter: userId : {}", userId);
        return products;
    }
}
