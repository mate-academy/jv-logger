...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        ...
        order.setOrderId(1L);
        logger.info("completeOrder method was called for User with ID: ({}) "
                + "Order #{}", userId, order.getOrderId());
        return order;
    }
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info("Products DATA was successfully fetched from DB. Products:{}{}",
                System.lineSeparator(), products.toString());
        return products;
    }
}
