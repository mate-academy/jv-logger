...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        logger.info(String.format("Method completeOrder was called. Params: userId = %d;", userId));
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info(String.format("Successful fetched data from DB. Params: userId = %d;", userId));
        return products;
    }
}
