...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        logger.info("The completeOrder method was called."
                + "Order completed for user {}", userId);
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info("The data were successfully retrieved from the database for user {}", userId);
        return products;
    }
}
