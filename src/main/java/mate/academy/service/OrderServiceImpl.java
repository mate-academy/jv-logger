...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        logger.debug("Method  completeOrder  was called with parameters: userId = {}",userId);
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.debug("Method  getAllProductsFromShoppingCart  successful fetched data from DB. "
                + "Params: userId={}; products={}", userId, products.toString());
        return products;
    }
}
