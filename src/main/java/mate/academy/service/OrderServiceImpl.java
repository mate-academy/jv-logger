...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        logger.debug("Method completeOrder called with params: userId - {}", userId);
        ...
        order.setOrderId(1L);
        logger.info("Method completeOrder(Long userId -- {}) is returning Order - {}", userId, order);
        return order;
    }

    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        logger.debug("Method getAllProductsFromShoppingCart called with params: userId - {}", userId);
        ...
        logger.info("Method getAllProductsFromShoppingCart fetched data from DB by userId - {}", userId);
        return products;
    }
}
