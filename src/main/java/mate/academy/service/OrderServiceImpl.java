...
public class OrderServiceImpl implements OrderService {
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info("Data successfully fetched from DB for {} product(s)", products.size());
        logger.debug("Products fetched from DB: {}",
                products.stream()
                        .map(product -> product.getTitle() + " (" + product.getPrice() + ")")
