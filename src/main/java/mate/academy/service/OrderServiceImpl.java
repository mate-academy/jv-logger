...
public class OrderServiceImpl implements OrderService {
    private static final Logger orderServiceImplLogger
            = LogManager.getLogger(OrderServiceImpl.class);

    @Override
    public Order completeOrder(Long userId) {
        //TODO: add log message about method completeOrder was called
        orderServiceImplLogger.info("Method completeOrder was called. Params : userId = {}",
                userId);
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        orderServiceImplLogger.info("Data was successfully fetched from DB");
        return products;
    }
}
