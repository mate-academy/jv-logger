...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        logger.debug("completeOrder method well by called. Params: completeOrder={}", userId);
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info("data successful fetched from data base. Params"
                + ": getAllProductsFromShoppingCart={}", userId);
        return products;
    }
}
