...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        logger.trace("Method completeOrder called");
        ...
        order.setOrderId(1L);
        logger.debug("Method completeOrder(Long userId -- {}) returned Order - {}", userId, order);
        return order;
    }

    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        logger.trace("Method getAllProductsFromShoppingCart "
                + "called");
        ...
        logger.debug("Method getAllProductsFromShoppingCart fetched "
