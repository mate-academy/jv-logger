...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        logger.debug("login method was called. Param: userId - {}", userId);
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info("getAllProductsFromShoppingCart, "
                + "products was successfully fetched from DB for userId {} ", userId);
        return products;
    }
}
