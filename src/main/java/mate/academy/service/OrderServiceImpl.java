...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        logger.debug("completeOrder method was invoked by user: {}", userId);
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info("getAllProductsFromShoppingCart successful fetched data from DB for user: {}", userId);
        return products;
    }
}
