...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        logger.debug("The completeOrder method has been called with parameter : usedId = {}", userId);
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info("The data for user has been successfully fetched from the DB with parameter: userId = {}", userId);
        return products;
    }
}
